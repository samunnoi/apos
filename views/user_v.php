<!--<label class="control-label" for="input01">Customer</label>-->
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="userid" style='padding: 10px 8px;' placeholder="User ID" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="name" style='padding: 10px 8px;' placeholder="Name" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="suname" style='padding: 10px 8px;' placeholder="Surname" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="personal" style='padding: 10px 8px;' placeholder="Personal ID" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="address1" style='padding: 10px 8px;' placeholder="Address" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="province" style='padding: 10px 8px;' placeholder="Province" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="post" style='padding: 10px 8px;' placeholder="Post Number" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="email" style='padding: 10px 8px;' placeholder="E-mail" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
		...
		<div class="input-group input-group-lg" style=''>
			...
			<input name="password" style='padding: 10px 8px;' placeholder="Password" type="text" class="form-control" value="<? if(isset($itemid)){echo $itemid;}?>" maxlength="15" required>
		</div> <br style='clear:both;'/>
