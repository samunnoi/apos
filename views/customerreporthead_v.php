...
.btn-input .btn.form-control .caret {
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <li><a href="#">Item Name</a></li>
		...
		<a href="<? if(isset($cutid_select)){echo site_url("excel/repcus/".$cutid_select); }?>"> <button id="btn3" style='padding: 10px 10px;' type="button" class="btn btn-default"><span style='padding-top: 1px;padding-bottom: 1px;' class="glyphicon glyphicon-list-alt"> Excel </span></button></a>
		</form>	 
